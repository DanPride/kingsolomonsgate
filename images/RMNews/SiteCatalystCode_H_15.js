...
function s_doPlugins(s) {
	if(s.events){if(s.events.indexOf("event1")==-1){s.events='event1, ' + s.events}}else{s.events='event1'}
	s.prop29=document.domain + " / SiteCatalystCode_H_15.js";
}
...
s.Media.trackEvents ="event13,event14,event15,event16,event21,event22,event23,event24,event25,event26" 
