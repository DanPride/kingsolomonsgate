...
//Server is in DC so unless they up an move the company and all its people to silicon valley this should do !
//If they do then change the letters EST to PST ! OMG the OOP Police must be up night with nightmares !
function dateFormat($date){
	return substr($date,5,2)  . "/"  . substr($date,8,2) . "/" . substr($date,0,4) . " " . substr($date,11,5) . " EST";
}
function reportDateFormat($date){
