<?php
    ...
    if (!empty($userAction))
    {
        ...
        if(empty($result))
        {
            $result = adminLogin($userid, $password);
            if ($result->isSuccess()) 
            {
                ...
                <div id="wrapper_content">
                	<div id="column_full">
                    	<div id="content_full">
                            ...
                            <p><small>What is Free Access ? - with one single log on your computer is identified and tracked. 
								<br> as long as your computer's IP address stays the same you never have to log on again !
								<br>No sessions to expire, no cookies to be stolen, your one screen password does it all !</small></p>
                            ...
                            <table border="0" width="100%">
                                <tr>
                                    ...
                                    <td><input type="text" name="userid" size=50 maxlength=10 value="admin"> </td>
                                </tr>
                                <tr>
                                    <th><h5 style="text-align: right;">Password</h5></th>
                                    <td><input type="password" name="password" size=50 maxlength=10 value="aaaaa"> </td>
                                </tr>
                                <tr>
