                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top" width="504" colspan="5">
                                                                ...
                                                                <div align="center">
                                                                	<a href="openfilereport.php">
                                                                    <img src="content/img/openFile.gif" 
                                                                    	alt="Current Open File Report" 
                                                                        border="0" 
                                                                        width="164" 
                                                                        height="32"></a>
                                                                </div>
                                                                ...
                                                                <form method="post" action=<?php echo "$_SERVER[PHP_SELF]", '#searchresults'; ?> >
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        ...
                                                                        <tr class="searchRow">
                                                                            <td colspan="3" align="left" valign="top" class="search_results">
                                                                                <input type="submit" name="userAction" value="Browse Most Recent" class="searchb">&nbsp;&nbsp;
                                                                    				<?php lengthPop(); ?>&nbsp;&nbsp;<br>
                                                                    			<input type="reset" value="Reset fields" class="searchb">&nbsp;&nbsp;<font style="display: none;"></font>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </form>
